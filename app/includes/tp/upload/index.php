...
<html>
    <head>
        ...
        <link href="<?php echo APP_INCLUDES . 'tp/upload/uploadify/default.css'?>" rel="stylesheet" type="text/css" />
  		<link href="<?php echo APP_INCLUDES . 'tp/upload//uploadify/uploadify.css'?>" rel="stylesheet" type="text/css" />
  		<link rel="stylesheet" href="<?php echo APP_INCLUDES . 'tp/upload/jcrop/jquery.Jcrop.css'?>" type="text/css" />
		<link rel="stylesheet" href="<?php echo APP_INCLUDES . 'tp/upload/jcrop/demos.css'?>" type="text/css" />
		<script type="text/javascript" language="/javascript" src="<?php echo APP_INCLUDES . 'tp/upload/jquery-1.3.2.js'?>"></script>
  		<script type="text/javascript" src="<?php echo APP_INCLUDES . 'tp/upload/uploadify/swfobject.js'?>"></script>		
		<style>
			body{
    ...
    <body>
			<div class="content">
				<div class="left">
					<div id="preview_container" class="preview_container">
						<img id="preview" src="<?php echo APP_INCLUDES . 'tp/upload/photos/picture.jpg'.'?'.time();?>"></img>
					</div>					
    	...
    	<script type="text/javascript" src="<?php echo APP_INCLUDES . 'tp/upload/uploadify/jquery.uploadify.v2.1.0.min.js'?>"></script>
  		<script src="<?php echo APP_INCLUDES . 'tp/upload/jcrop/jquery.Jcrop.min.js'?>"></script>
