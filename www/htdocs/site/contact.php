    ...
    <body id="pageSchoolHome" class="threeColumn">
        <div id="container">
            ...
            <div id="footer">
                ...
                <div class="placeholderLeft"></div><div class="placeholderRight"></div><div id="footerLinks"><a href="/<?php echo getParam(1) ?>/<?php echo getParam(2) ?>/">Home</a>|<a href="/<?php echo getParam(1) ?>/<?php echo getParam(2) ?>/contact/">Contact Us</a>|<a href="/<?php echo getParam(1) ?>/<?php echo getParam(2) ?>/hippa/">HIPAA</a><!--|<a href="/">Sitemap</a>--></div><div id="copyright">&copy; <?php echo date("Y") ?> Academic HealthPlans, Inc.  |  All Rights Reserved</div>
            </div>
            ...
            <div id="content">
                ...
                <div id="column1" style="height:547px">
                    <?php $aContent = $oRender->getColumnContent($sSchoolSlug, $sPeriodSlug, 'Contact-Enrolment'); ?>
                    <?php if (count($aContent) > 0): ?>
                        <ul>
                            <li class="formatFix"><div>&nbsp;</div></li>
                            <? foreach ($aContent as $oContent): ?>
                ...
                <div id="column2" style="height:547px">
                    <?php $aContent = $oRender->getColumnContent($sSchoolSlug, $sPeriodSlug, 'Contact-Benefits'); ?>
                    <?php if (count($aContent) > 0): ?>
                        <ul>
                            <li class="formatFix"><div>&nbsp;</div></li>
                            <? foreach ($aContent as $oContent): ?>
                ...
                <div id="column3" style="height:547px">
                    <?php $aContent = $oRender->getColumnContent($sSchoolSlug, $sPeriodSlug, 'Contact-Claims'); ?>
                    <?php if (count($aContent) > 0): ?>
                        <ul>
                            <li class="formatFix"><div>&nbsp;</div></li>
                            <? foreach ($aContent as $oContent): ?>
